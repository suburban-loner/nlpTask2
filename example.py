...
# The numbers indicating similarity are lower when I run the 'en_core_web_sm' language model 
# compared to when i run the 'en_core_web_md'. And the 'en_core_web_sm' shows a UserWarning 
# before showing me the similarities.
